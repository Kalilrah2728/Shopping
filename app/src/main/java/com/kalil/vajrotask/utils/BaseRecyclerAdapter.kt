...
abstract class BaseRecyclerAdapter<T : ViewDataBinding>(private var context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val dataBinding: T =
            DataBindingUtil.inflate(LayoutInflater.from(context), getLayout(), parent, false)
